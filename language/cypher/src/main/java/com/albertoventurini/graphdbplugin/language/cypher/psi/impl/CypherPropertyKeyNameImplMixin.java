...
public class CypherPropertyKeyNameImplMixin extends ASTWrapperPsiElement
    ...
    public CypherPropertyKeyNameImplMixin(@NotNull ASTNode node) {
        super(node);
    }
    ...
    public PsiElement setName(@NlsSafe @NotNull String name) throws IncorrectOperationException {
        CypherPropertyKeyName newRelTypeNameNode = CypherElementFactory
                .createPropertyKeyNameNode(this.getProject(), name);
        safelyReplaceSymbolicName(this, newRelTypeNameNode);
        return this;
    }
